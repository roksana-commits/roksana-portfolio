...
const journeyMilestones = [
  { period: "2018 / ORIGIN", company: "Freelancing begins", title: "Amazon Affiliate Marketer", detail: "Built Amazon affiliate websites and learned the publishing-to-conversion workflow behind affiliate marketing: selecting a niche, researching products, creating useful content, and connecting readers to relevant Amazon listings.", responsibilities: ["Built and organized Amazon affiliate websites", "Researched niches, products, comparisons, and buyer-intent topics", "Created SEO-aware content and placed relevant affiliate links"] },
];
...
const timelineEntries = [
  { period: "2018", tag: "ORIGIN", company: "Freelancing begins", title: "Amazon Affiliate Marketer", detail: "Built Amazon affiliate websites and learned the publishing-to-conversion workflow behind affiliate marketing: selecting a niche, researching products, creating useful content, and connecting readers to relevant Amazon listings.", responsibilities: ["Built and organized Amazon affiliate websites", "Researched niches, products, comparisons, and buyer-intent topics", "Created SEO-aware content and placed relevant affiliate links"] },
  { period: "2022 — PRESENT", tag: "ROLE 01", company: "Lighthouse Internet Media", title: "Digital Administrator", detail: "Supporting digital operations across technical SEO, AI search optimization, research, data workflows, web management, and client social media work.", responsibilities: ["Technical SEO and AI Search Optimization support", "Competitor research, structured data analysis, and web extraction", "Social media page creation, setup, and content posting for clients"] },
  { period: "2022 — PRESENT", tag: "ROLE 02", company: "socialbook.io", title: "Data Enrich Administrator", detail: "Organizing, enriching, and maintaining structured data so teams can work from cleaner, more useful information.", responsibilities: ["Data enrichment and quality-focused record maintenance", "Research, verification, and structured information management", "Consistent delivery of clean, usable data for downstream teams"] },
];
    ...
    <div className="about-page">
      ...
      <main>
        <section className="about-hero section-wrap">
          <div className="about-hero-copy"><div className="eyebrow"><span className="eyebrow-dot" /> ABOUT THE OPERATOR <span className="mono">/ 2026</span></div><h1>Search is changing.<br /><em>Good information</em><br />still matters.</h1><div className="about-experience-stamp"><strong>9<span>+</span></strong><span>YEARS IN PRACTICE<br />FREELANCING SINCE 2018</span></div><p className="about-lead">Hi, I’m Roksana—a Technical SEO, AI Search Optimization, and Data Intelligence Specialist with 9+ years of experience, freelancing since 2018, and 240+ successfully completed projects on Freelancer.com.</p><p>I help businesses improve organic visibility, AI search presence, and data-driven decision-making through technical SEO, competitor research, structured data analysis, and web data extraction.</p></div>
        ...
        <section className="about-proof-band"><div className="section-wrap about-proof-grid"><div><span className="mono">PROFILE SIGNAL</span><strong>Practical clarity<br />over noise.</strong></div><div><strong>9<span>+</span></strong><span>Years across freelancing and digital operations</span></div><div><strong>240<span>+</span></strong><span>Completed Freelancer projects</span></div><div><strong>100<span>%</span></strong><span>Project completion rate</span></div></div></section>
