...
function SocialLink({ href, label, children }: { href: string; label: string; children: ReactNode }) {
  return (
    <Tooltip>
      ...
      <TooltipContent side="bottom" sideOffset={8} className="social-tooltip">{label}</TooltipContent>
    </Tooltip>
  );
}
